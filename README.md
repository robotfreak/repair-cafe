...
| **VDE/DGUV-Prüfung (optional)** | Geräte tragen eine Schutzklasse (SK I/II/III, optional Heizleistung kW). Am Laufzettel erscheint je Schutzklasse eine Checkliste. **Seit 2026-09-05:** Wir verwenden eine vereinfachte Isolationsprüfung mit UNI-T UT-501 statt vollständiger VDE-Prüfung. Dies ist NICHT VDE-konform, aber für Repair-Café Zwecke ausreichend (Haftungsausschluss beachten!). **Prüfmittel-Verwaltung:** Messgeräte (Name, Seriennummer, „kalibriert bis") liegen in der DB und werden per Dropdown zugeordnet — jede Prüfung dokumentiert das verwendete Messgerät mit Snapshot. **Die Prüfung ist freiwillig** — keine Pflicht für die Rückgabe. **Anleitung:** Siehe [UNI-T UT-501 Bedienanleitung](docs/UNI-T-UT501-Anleitung.md). |
